...
void mda_hline_caps(mda_point_t* point, mda_cell_t* cells);

// (3 cells) - top end cap, vline, bottom end cap
void mda_vline_caps(mda_point_t* point, mda_cell_t* cells);
...
void mda_border(mda_rect_t* rect, mda_cell_t* cells);
