 ...
 * @{
 */
void mda_ctrl_BEL(mda_context_t* ctx);  ///< Sound bell (CRTL-G)
void mda_ctrl_BS(mda_context_t* ctx);   ///< Backspace: move left, no underflow
void mda_ctrl_HT(mda_context_t* ctx);   ///< Horizontal tab: advance to next HT stop
void mda_ctrl_LF(mda_context_t* ctx);   ///< Line Feed: move down, scroll if needed
...
void mda_ctrl_CR(mda_context_t* ctx);   ///< Carriage Return: move to start of line
